...
class AnimalActivityWidget extends StatefulWidget {
  final Animal animal;
  const AnimalActivityWidget({super.key, required this.animal});

  @override
  State<AnimalActivityWidget> createState() => _AnimalActivityWidgetState();
}

class _AnimalActivityWidgetState extends State<AnimalActivityWidget> {
              ...
              Container(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: [
                      theme.brightness == Brightness.light ? gdGradientStart : gdDarkGradientStart,
