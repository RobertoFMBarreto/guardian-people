...
class _GeofencingState extends State<Geofencing> {
  ...
  //   );
  //   if (widget.fence != null) {
  //     _editingPolygon.points.addAll(_fencePoints as Iterable<LatLng>);
  //   }
  // }
  ...
  //         setState(() {
  //           _fencePoints = [];
  //           _fencePoints.addAll(allPoints as Iterable<LatLng>);
  //         });
  //       }
  //     },
  //   );
  ...
  //   createFencePointFromList(_editingPolygon.points.cast<LatLng>(), idFence).then(
