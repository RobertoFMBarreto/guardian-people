...
class AnimalProvider {
  ...
  static Future<Response> startRealtimeStreaming(String idAnimal) async {
    ...
    var url = Uri.https(kGDapiServerUrl, '/api/v1/animals/locations/subscription/$idAnimal/start');
    try {
  ...
  static Future<Response> stopRealtimeStreaming(String idAnimal) async {
    ...
    var url = Uri.https(kGDapiServerUrl, '/api/v1/animals/locations/subscription/$idAnimal/cancel');
    try {
      var response = await get(url, headers: headers);
